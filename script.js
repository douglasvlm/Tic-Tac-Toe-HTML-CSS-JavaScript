...
function mudarJogador(valor) {
    jogador = valor;
    jogadorSelecionado.innerHTML = 'Sua vez de jogar "Jogador" : ' + jogador;
}
...
function checaVencedor(){
    ...
    if (quadrado1.innerHTML !== '-' && quadrado2.innerHTML !== '-' && quadrado3.innerHTML !== '-' && 
        ...
        mudarVencedor('Empate');
    }
}

function mudarVencedor(verificador) {
    jogadorSelecionado.innerHTML = '';
    if (verificador!== 'Empate'){
        vencedor = verificador.innerHTML;
        vencedorSelecionado.innerHTML = 'Vencedor "Jogador": ' + vencedor;
    }else{    
        vencedorSelecionado.innerHTML = 'Empatou!!!';    
    }    
}
